...
const ProductsGrid = () => {
    ...
    return (
        ...
        flex flex-col justify-center items-center gap-4">
            ...
            font-semibold text-[42px] leading-[50px] text-center">
                Trending Products
            </h1>
            <div data-aos="zoom in" data-aos-delay="300" className="w-full grid lg:grid-cols-4 grid-cols-1 justify-center
            items-center gap-10 mt-10">
                {
                    products.map((item, index) => (
                        <div id="product-box" key={index} className="flex flex-col justify-center
                        items-center gap-2 bg-white p-4 rounded-lg cursor-pointer relative">
                            <img
                                src={item.img}
                                alt="products-box"
                            />
                            ...
                            absolute top-[20px]">
                                <div className="bg-themepurple hover:bg-themeyellow transition-colors
                                hover:text-black rounded-full p-2.5 text-white">
            ...
            text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8 delay-200 transition-colors">
                VIEW MORE
            </button>
        </div>
    )
